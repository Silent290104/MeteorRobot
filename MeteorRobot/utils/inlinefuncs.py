...
from MeteorRobot import pbot as app 
from MeteorRobot import arq
from MeteorRobot.services.keyboard import Ikb
from MeteorRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from MeteorRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from MeteorRobot.services.types import InlineQueryResultCachedDocument
from MeteorRobot.modules.info import get_chat_info, get_user_info
from MeteorRobot.modules.music import download_youtube_audio
from MeteorRobot.utils.functions import test_speedtest
from MeteorRobot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://te.legra.ph/file/0f9822937feae34b97a52.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Silent_Robo_Bot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Meteor Robot ❤️](https://t.me/Silent_robo_11):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Silent_Smile_04)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    chat_id = -1001637993533
    group_invite = "https://t.me/Silent_robo_11?videochat=7d1d778373d977356d"
    try:
        messages = [
            m
