...
import MeteorRobot.modules.sql.notes_sql as sql
from MeteorRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from MeteorRobot.__main__ import DATA_IMPORT
from MeteorRobot.modules.helper_funcs.chat_status import user_admin
from MeteorRobot.modules.helper_funcs.alternate import typing_action

# from MeteorRobot.modules.rules import get_rules
import MeteorRobot.modules.sql.rules_sql as rulessql

# from MeteorRobot.modules.sql import warns_sql as warnssql
import MeteorRobot.modules.sql.blacklist_sql as blacklistsql
from MeteorRobot.modules.sql import disable_sql as disabledsql

# from MeteorRobot.modules.sql import cust_filters_sql as filtersql
# import MeteorRobot.modules.sql.welcome_sql as welcsql
import MeteorRobot.modules.sql.locks_sql as locksql
from MeteorRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("MeteorRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("MeteorRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `MeteorRobot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("MeteorRobot{}.backup".format(chat_id))  # Cleaning file
