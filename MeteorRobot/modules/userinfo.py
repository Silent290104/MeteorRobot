...
from MeteorRobot.__main__ import STATS, TOKEN, USER_INFO
from MeteorRobot.modules.sql import SESSION
import MeteorRobot.modules.sql.userinfo_sql as sql
from MeteorRobot.modules.disable import DisableAbleCommandHandler
from MeteorRobot.modules.sql.global_bans_sql import is_user_gbanned
from MeteorRobot.modules.sql.afk_sql import is_afk, set_afk
from MeteorRobot.modules.sql.users_sql import get_user_num_chats
from MeteorRobot.modules.helper_funcs.chat_status import sudo_plus
from MeteorRobot.modules.helper_funcs.extraction import extract_user
from MeteorRobot import telethn
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Meteor Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
